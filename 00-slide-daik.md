...
<!--
Mở đầu bằng câu hỏi giơ tay, KHÔNG bằng slide này.
Để slide này trên màn hình trong lúc hỏi.
-->
...
<!--
Chờ tay giơ thật. Đừng đọc tiếp ngay.
Sẽ gần như cả phòng giơ tay ở câu 1.
-->
...
**2.** Và cả hai **đang tốn tiền công ty** nhiều hơn mọi người tưởng.

**3.** Hôm nay có 6 bước. **Hai bước giữa** quan trọng nhất — bốn bước còn lại là để hỗ trợ hai bước đó.

<!--
Nói ba câu này rồi đi tiếp ngay, đừng giải thích vội.
Đừng mở đầu bằng "AI rất mạnh mẽ" — cả phòng dùng rồi.
-->
...
<!--
Chỉ vào ② và ③: "hai phần này là lý do cả buổi hôm nay tồn tại".
-->
...
<!--
Đây là tiền đề cho cả bước 1 và bước 4.
-->
...
<!--
Đừng sa đà vào 4 tầng. Hai tầng này đủ dùng cho 95% trường hợp.
-->
...
<!--
DỪNG Ở ĐÂY. Bảo cả phòng mở terminal làm theo.
-->
...
<!--
Để 2 phút. Đi vòng quanh xem ai kẹt.
-->
...
<!--
Đa số trường hợp "sao Claude không nghe lời tôi" là do file đặt sai chỗ,
không phải do Claude.
-->
...
<!--
Sẽ có người hỏi: "viết vào đây nó có CHẮC CHẮN nghe không?"
Trả lời thẳng: KHÔNG. Đây là gợi ý, không phải ràng buộc.
Muốn ràng buộc → chờ phần ⑥.
-->
...
<!--
Đọc to đoạn này. Rồi hỏi: "ai thấy quen tay giơ lên".
-->
...
<!--
Nhấn: "mình chỉ gõ một câu 10 chữ, nhưng hệ thống gửi lại tất cả".
-->
...
<!--
Ai cũng từng gặp: "ơ nãy sửa rồi mà sao nó làm lại?"
-->
...
<!--
Đây là điểm phản trực giác nhất. Nhấn mạnh.
-->
...
<!--
Câu đắt nhất của phần này. Dừng 2 giây sau khi nói.
-->
...
<!--
Nhấn: đây không phải ý kiến của mình, đây là tài liệu chính thức.
-->
...
<!--
Đây là thứ team có thể áp dụng ngay chiều nay. Cụ thể, dễ nhớ, tự kiểm được.
-->
...
<!--
CHUYỂN SANG DEMO NGAY SAU SLIDE NÀY.
-->
...
## Plan mode trên repo thật

<!--
DEMO 4 PHÚT — quan trọng nhất cả buổi:
1. Mở repo thật, Shift+Tab → chỉ vào "⏸ plan mode on"
2. Gõ một yêu cầu thật của dự án
3. Để Claude đọc code và trình kế hoạch
4. CHỈ VÀO MỘT DÒNG SAI và nói:
   "Chỗ này sai. Sửa bây giờ mất 10 giây.
    Để nó code xong 8 file rồi mới phát hiện thì mất bao lâu?"
5. Ctrl+G sửa trực tiếp, rồi cho chạy
-->
...
<!--
Slide này để phòng thủ trước câu hỏi "làm vậy chậm hơn tự code".
-->
...
<!--
Đây là món nhiều người sẽ dùng nhất. Đọc to cả prompt.
Claude sẽ hỏi: "tồn kho âm hiển thị sao?", "phân trang server hay client?"
— những thứ mình chưa nghĩ tới.
-->
...
<!--
Đảo ngược thói quen: thay vì "nói thêm câu nữa để sửa",
hãy "quay về sửa câu ban đầu".
Lưu ý: checkpoint không theo dõi thay đổi qua lệnh Bash. Không thay thế git.
-->
...
<!--
Claude dừng khi công việc TRÔNG CÓ VẺ xong.
Không có gì kiểm chứng thì "trông có vẻ xong" là tín hiệu duy nhất nó có
— và mình trở thành vòng lặp kiểm thử.
-->
...
<!--
Để slide này trên màn hình lâu một chút. Chụp ảnh được.
-->
...
<!--
Vẽ ẩn dụ trước. ĐỪNG nói "token" vội.
-->
...
<!--
Viết 3 ý này lên bảng, để nguyên suốt phần ③.
"Câu số 2 giải thích được 90% chi phí."
-->
...
<!--
Để 30 giây. Rồi hỏi: "ai đang trên 50%?"
Sau đó chiếu con số của phiên lộn xộn đã chuẩn bị sẵn từ hôm trước.
-->
...
<!--
Bài học: thứ tốn nhiều nhất không phải câu mình gõ,
mà là FILE CLAUDE ĐỌC và OUTPUT LỆNH NÓ CHẠY.
-->
...
<!--
Điểm rất ít người biết. Đáng nhấn.
-->
...
<!--
Thứ đáng giá nhất mà ít người dùng.
Ba tình huống: điều tra codebase, xử lý log dài, review chéo.
-->
...
<!--
Tài liệu nói thẳng: chi phí cao bất thường thường do HAI thứ —
để Opus làm mặc định, và không bao giờ /clear.
-->
...
<!--
DEMO 2 PHÚT: chạy /init trên repo thật, vừa chạy vừa giải thích.
-->
...
<!--
Mẹo 1 giải quyết mâu thuẫn "muốn viết nhiều nhưng phải dưới 200 dòng".
-->
...
<!--
`description` quan trọng hơn nội dung.
Nội dung hay mà mô tả dở thì Claude không bao giờ mở tới.
Viết bằng TỪ NGỮ NGƯỜI DÙNG THẬT SỰ SẼ GÕ.
-->
...
<!--
Viết "đừng đọc thư mục secrets" vào CLAUDE.md thì Claude VẪN ĐỌC ĐƯỢC.
Muốn cấm thật thì phải viết deny rule.
-->
...
<!--
Windows: nhớ tiền tố // để khớp mọi ổ đĩa.
Và phải viết Read(...), không phải Glob(...) — rule Glob bị bỏ qua.
-->
...
<!--
Giảm số lần hỏi là để DÀNH SỰ CHÚ Ý cho thứ thật sự nguy hiểm.
-->
...
<!--
ĐỪNG tóm tắt lại 6 bước. Cả phòng vừa nghe xong.
-->
...
<!--
Slide dự phòng — chỉ mở khi có người hỏi.
-->
...
Xem Commercial Terms và Privacy Center — dẫn link, đừng trả lời ứng khẩu.
